...
Scope: feature branch `feature/line-official-readonly-bot`

Decision: **CONDITIONAL / not production-ready until the gates below pass**
...
## 6. Connectivity and operations — CONDITIONAL
...
1. Confirm Supabase backup.
2. Review and apply migration.
3. Store the two LINE secrets and confirm Supabase's auto-provided default
   backend key without exposing any value.
4. Deploy the Edge Function.
5. Configure and verify the LINE webhook.
6. Complete owner acceptance on Full and Mobile.
7. Re-run this audit with live evidence and change the decision explicitly.
