...
# This list must match AUTH_RECOVERY_RELATIONS in the dump extractor. It is
# intentionally limited to durable user-facing Auth state; Supabase service
# bootstrap ledgers and transient flow-state tables are regenerated.
AUTH_RECOVERY_RELATIONS = (
    "auth.users",
    "auth.identities",
    "auth.sessions",
    "auth.refresh_tokens",
...
CORE_RELATIONS = AUTH_RECOVERY_RELATIONS + PUBLIC_RECOVERY_RELATIONS
