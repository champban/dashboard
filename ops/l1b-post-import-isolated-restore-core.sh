...
if [[ "${1:-}" == "--selftest" ]]; then
  ...
  [[ '77920aa928188c3c5ad5cd6663299fe9' =~ ^[0-9a-f]{32}$ ]]
  [[ '7bfa00c87f46152bc58b797f344d1e37' =~ ^[0-9a-f]{32}$ ]]
  [[ '29ba83e72a1444f0f340b644658bf59b' =~ ^[0-9a-f]{32}$ ]]
  [[ '4a448ec93b102ce47d18818599707916' =~ ^[0-9a-f]{32}$ ]]
...
: "${EXPECTED_AICC_PRODUCTION_FINGERPRINT:?EXPECTED_AICC_PRODUCTION_FINGERPRINT is required}"
: "${EXPECTED_AICC_REL_PARTS:?EXPECTED_AICC_REL_PARTS is required}"
: "${EXPECTED_AICC_REL_FINGERPRINT:?EXPECTED_AICC_REL_FINGERPRINT is required}"
: "${EXPECTED_AICC_COL_PARTS:?EXPECTED_AICC_COL_PARTS is required}"
: "${EXPECTED_AICC_COL_FINGERPRINT:?EXPECTED_AICC_COL_FINGERPRINT is required}"
: "${EXPECTED_AICC_POL_PARTS:?EXPECTED_AICC_POL_PARTS is required}"
: "${EXPECTED_AICC_POL_FINGERPRINT:?EXPECTED_AICC_POL_FINGERPRINT is required}"
: "${EXPECTED_AICC_FUN_PARTS:?EXPECTED_AICC_FUN_PARTS is required}"
: "${EXPECTED_AICC_FUN_FINGERPRINT:?EXPECTED_AICC_FUN_FINGERPRINT is required}"
...
: "${EXPECTED_AICC_CONSTRAINT_PARTS:?EXPECTED_AICC_CONSTRAINT_PARTS is required}"
: "${EXPECTED_AICC_CONSTRAINT_FINGERPRINT:?EXPECTED_AICC_CONSTRAINT_FINGERPRINT is required}"
: "${EXPECTED_AICC_FUNCDEF_PARTS:?EXPECTED_AICC_FUNCDEF_PARTS is required}"
: "${EXPECTED_AICC_FUNCDEF_FINGERPRINT:?EXPECTED_AICC_FUNCDEF_FINGERPRINT is required}"
: "${EXPECTED_AICC_INDEX_PARTS:?EXPECTED_AICC_INDEX_PARTS is required}"
: "${EXPECTED_AICC_INDEX_FINGERPRINT:?EXPECTED_AICC_INDEX_FINGERPRINT is required}"
: "${EXPECTED_AICC_TRIGGER_PARTS:?EXPECTED_AICC_TRIGGER_PARTS is required}"
: "${EXPECTED_AICC_TRIGGER_FINGERPRINT:?EXPECTED_AICC_TRIGGER_FINGERPRINT is required}"
: "${EXPECTED_L0B_CONSTRAINT_PARTS:?EXPECTED_L0B_CONSTRAINT_PARTS is required}"
: "${EXPECTED_L0B_CONSTRAINT_FINGERPRINT:?EXPECTED_L0B_CONSTRAINT_FINGERPRINT is required}"
: "${EXPECTED_L0B_FUNCDEF_PARTS:?EXPECTED_L0B_FUNCDEF_PARTS is required}"
: "${EXPECTED_L0B_FUNCDEF_FINGERPRINT:?EXPECTED_L0B_FUNCDEF_FINGERPRINT is required}"
: "${EXPECTED_L0B_SEMANTIC_INDEX_PARTS:?EXPECTED_L0B_SEMANTIC_INDEX_PARTS is required}"
: "${EXPECTED_L0B_SEMANTIC_INDEX_FINGERPRINT:?EXPECTED_L0B_SEMANTIC_INDEX_FINGERPRINT is required}"
: "${EXPECTED_L0B_TRIGGER_PARTS:?EXPECTED_L0B_TRIGGER_PARTS is required}"
: "${EXPECTED_L0B_TRIGGER_FINGERPRINT:?EXPECTED_L0B_TRIGGER_FINGERPRINT is required}"
: "${EXPECTED_LINE_CONSTRAINT_PARTS:?EXPECTED_LINE_CONSTRAINT_PARTS is required}"
: "${EXPECTED_LINE_CONSTRAINT_FINGERPRINT:?EXPECTED_LINE_CONSTRAINT_FINGERPRINT is required}"
: "${EXPECTED_LINE_FUNCDEF_PARTS:?EXPECTED_LINE_FUNCDEF_PARTS is required}"
: "${EXPECTED_LINE_FUNCDEF_FINGERPRINT:?EXPECTED_LINE_FUNCDEF_FINGERPRINT is required}"
: "${EXPECTED_LINE_SEMANTIC_INDEX_PARTS:?EXPECTED_LINE_SEMANTIC_INDEX_PARTS is required}"
: "${EXPECTED_LINE_SEMANTIC_INDEX_FINGERPRINT:?EXPECTED_LINE_SEMANTIC_INDEX_FINGERPRINT is required}"
: "${EXPECTED_LINE_TRIGGER_PARTS:?EXPECTED_LINE_TRIGGER_PARTS is required}"
: "${EXPECTED_LINE_TRIGGER_FINGERPRINT:?EXPECTED_LINE_TRIGGER_FINGERPRINT is required}"
...
if [[ "$EXPECTED_LINE_FINGERPRINT" != 'e0977efa7ccc1f340e753fe470d19da2' \
   ...
   || "$EXPECTED_AICC_REL_PARTS" != '32' \
   || "$EXPECTED_AICC_REL_FINGERPRINT" != '77920aa928188c3c5ad5cd6663299fe9' \
   || "$EXPECTED_AICC_COL_PARTS" != '166' \
   || "$EXPECTED_AICC_COL_FINGERPRINT" != '7bfa00c87f46152bc58b797f344d1e37' \
   || "$EXPECTED_AICC_POL_PARTS" != '14' \
   || "$EXPECTED_AICC_POL_FINGERPRINT" != '29ba83e72a1444f0f340b644658bf59b' \
   || "$EXPECTED_AICC_FUN_PARTS" != '6' \
   || "$EXPECTED_AICC_FUN_FINGERPRINT" != '4a448ec93b102ce47d18818599707916' \
...
: >"$CORE_COUNT_CHECK_LOG"
chmod 600 "$CORE_COUNT_CHECK_LOG"
if ! python3 "$CHECKER" extract "$EXTRACT_DIR/data.sql" "$EXPECTED_COUNTS" >"$CORE_COUNT_CHECK_LOG" 2>&1; then
...
BEGIN SELECT count(*),md5(coalesce(string_agg(part,E'\n' ORDER BY part),'')) INTO n,d
FROM (
 ...
 END IF;
END;$pre$;
GRANT EXECUTE ON FUNCTION public.aicc_add_owner_membership() TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aicc_audit_agent_status() TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aicc_audit_message_insert() TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aicc_audit_task_status() TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aicc_set_updated_at() TO PUBLIC;
GRANT EXECUTE ON FUNCTION public.aicc_task_timestamps() TO PUBLIC;
DO $post$
DECLARE n bigint; d text;
BEGIN SELECT count(*),md5(coalesce(string_agg(part,E'\n' ORDER BY part),'')) INTO n,d
FROM (
...
grep -Fxq $'AICC_REL\t'"$EXPECTED_AICC_REL_PARTS"$'\t'"$EXPECTED_AICC_REL_FINGERPRINT" "$FINGERPRINTS"
grep -Fxq $'AICC_COL\t'"$EXPECTED_AICC_COL_PARTS"$'\t'"$EXPECTED_AICC_COL_FINGERPRINT" "$FINGERPRINTS"
grep -Fxq $'AICC_POL\t'"$EXPECTED_AICC_POL_PARTS"$'\t'"$EXPECTED_AICC_POL_FINGERPRINT" "$FINGERPRINTS"
grep -Fxq $'AICC_FUN\t'"$EXPECTED_AICC_FUN_PARTS"$'\t'"$EXPECTED_AICC_FUN_FINGERPRINT" "$FINGERPRINTS"
